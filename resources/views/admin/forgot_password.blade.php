...
<head>
  ...
  <title>@lang('admin.forgot_password')</title>
...
<div class="login-box">
  ...
  <div class="login-box-body">
    <p class="login-box-msg">@lang('admin.forgot_password')</p>
    ...
    <div>
      <h3 class="alert alert-warning text-justify text-center">{{session('not_valid')}}</h3>
      </div>
    @endif
...
<!--     <div class="social-auth-links text-center">
    ...
    <a href="{{aurl('login')}}">@lang('sign in')</a><br>
